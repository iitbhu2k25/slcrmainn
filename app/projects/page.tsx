...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "For Recharge sites, aims to enhance base flow through managed Aquifer recharge (MAR). Advance geophysical techniques and mathematical modelling to identify optimal recharge sites and rates",
